...
exports.runScopeHandlers = exports.placeholder = exports.logException = exports.keymap = exports.highlightSpecialChars = exports.highlightActiveLine = exports.drawSelection = exports.__test = exports.WidgetType = exports.ViewUpdate = exports.ViewPlugin = exports.PluginFieldProvider = exports.PluginField = exports.MatchDecorator = exports.EditorView = exports.Direction = exports.Decoration = exports.BlockType = exports.BlockInfo = exports.BidiSpan = exports.Range = undefined;
...
var _ref = typeof navigator != "undefined" ? [navigator, document] : [{ userAgent: "", vendor: "", platform: "" }, { documentElement: { style: {} } }],
    ...
    for (var cur = dom.parentNode; cur;) {
        if (cur.nodeType == 1) {
            ...
            if (top) {
                ...
                bounding = { left: _rect.left, right: _rect.left + cur.clientWidth,
                    top: _rect.top, bottom: _rect.top + cur.clientHeight };
            }
            var moveX = 0,
                moveY = 0;
...
var ContentView = function () {
    ...
    _createClass(ContentView, [{
        ...
        value: function replaceChildren(from, to) {
            ...
            }(_children = this.children).splice.apply(_children, [from, to - from].concat(_toConsumableArray(children)));
...
var InlineView = function (_ContentView) {
    _inherits(InlineView, _ContentView);

    function InlineView() {
        _classCallCheck(this, InlineView);

        return _possibleConstructorReturn(this, (InlineView.__proto__ || Object.getPrototypeOf(InlineView)).apply(this, arguments));
    }
...
var TextView = function (_InlineView) {
    _inherits(TextView, _InlineView);

    function TextView(text) {
        _classCallCheck(this, TextView);

        var _this2 = _possibleConstructorReturn(this, (TextView.__proto__ || Object.getPrototypeOf(TextView)).call(this));
...
var MarkView = function (_InlineView2) {
    ...
    function MarkView(mark) {
        ...
        var _this3 = _possibleConstructorReturn(this, (MarkView.__proto__ || Object.getPrototypeOf(MarkView)).call(this));
    ...
    _createClass(MarkView, [{
        ...
        value: function sync(track) {
            if (!this.dom) this.createDOM();
            _get(MarkView.prototype.__proto__ || Object.getPrototypeOf(MarkView.prototype), 'sync', this).call(this, track);
        }
    }, {
        key: 'merge',
...
var WidgetView = function (_InlineView3) {
    _inherits(WidgetView, _InlineView3);

    function WidgetView(widget, length, side) {
        _classCallCheck(this, WidgetView);

        var _this4 = _possibleConstructorReturn(this, (WidgetView.__proto__ || Object.getPrototypeOf(WidgetView)).call(this));
...
var CompositionView = function (_WidgetView) {
    _inherits(CompositionView, _WidgetView);

    function CompositionView() {
        _classCallCheck(this, CompositionView);

        return _possibleConstructorReturn(this, (CompositionView.__proto__ || Object.getPrototypeOf(CompositionView)).apply(this, arguments));
    }
...
function mergeInlineChildren(parent, from, to, elts, openStart, openEnd) {
    ...
    try {
        for (var _iterator5 = elts[Symbol.iterator](), _step5; !(_iteratorNormalCompletion5 = (_step5 = _iterator5.next()).done); _iteratorNormalCompletion5 = true) {
...
function attrsEq(a, b) {
    ...
    try {
        for (var _iterator7 = keysA[Symbol.iterator](), _step7; !(_iteratorNormalCompletion7 = (_step7 = _iterator7.next()).done); _iteratorNormalCompletion7 = true) {
...
var Decoration = function (_RangeValue) {
    ...
    spec) {
        ...
        var _this6 = _possibleConstructorReturn(this, (Decoration.__proto__ || Object.getPrototypeOf(Decoration)).call(this));

        _this6.startSide = startSide;
        _this6.endSide = endSide;
    ...
    return Decoration;
}(_rangeset.RangeValue);
/// The empty set of decorations.


Decoration.none = _rangeset.RangeSet.empty;

var MarkDecoration = function (_Decoration) {
    ...
    function MarkDecoration(spec) {
        ...
        var _this7 = _possibleConstructorReturn(this, (MarkDecoration.__proto__ || Object.getPrototypeOf(MarkDecoration)).call(this, 100000000 /* BigInline */ * (start ? -1 : 1), 100000000 /* BigInline */ * (end ? 1 : -1), null, spec));

        _this7.tagName = spec.tagName || "span";
        _this7.class = spec.class || "";
        _this7.attrs = spec.attributes || null;
        return _this7;
    }
    ...
    _createClass(MarkDecoration, [{
        ...
        value: function range(from) {
            ...
            return _get(MarkDecoration.prototype.__proto__ || Object.getPrototypeOf(MarkDecoration.prototype), 'range', this).call(this, from, to);
        }
    }]);
...
var LineDecoration = function (_Decoration2) {
    _inherits(LineDecoration, _Decoration2);

    function LineDecoration(spec) {
        _classCallCheck(this, LineDecoration);

        return _possibleConstructorReturn(this, (LineDecoration.__proto__ || Object.getPrototypeOf(LineDecoration)).call(this, -100000000 /* BigInline */, -100000000 /* BigInline */, null, spec));
    }
    ...
    _createClass(LineDecoration, [{
        ...
        value: function range(from) {
            ...
            return _get(LineDecoration.prototype.__proto__ || Object.getPrototypeOf(LineDecoration.prototype), 'range', this).call(this, from, to);
        }
    }]);
...
LineDecoration.prototype.mapMode = _state2.MapMode.TrackBefore;
LineDecoration.prototype.point = true;

var PointDecoration = function (_Decoration3) {
    ...
    function PointDecoration(spec, startSide, endSide, block, widget, isReplace) {
        ...
        var _this9 = _possibleConstructorReturn(this, (PointDecoration.__proto__ || Object.getPrototypeOf(PointDecoration)).call(this, startSide, endSide, widget, spec));

        _this9.block = block;
        _this9.isReplace = isReplace;
        _this9.mapMode = !block ? _state2.MapMode.TrackDel : startSide < 0 ? _state2.MapMode.TrackBefore : _state2.MapMode.TrackAfter;
        return _this9;
    }
    ...
    _createClass(PointDecoration, [{
        ...
        value: function range(from) {
            ...
            return _get(PointDecoration.prototype.__proto__ || Object.getPrototypeOf(PointDecoration.prototype), 'range', this).call(this, from, to);
        }
    }, {
        key: 'type',
        get: function get() {
...
var LineView = function (_ContentView2) {
    _inherits(LineView, _ContentView2);

    function LineView() {
        _classCallCheck(this, LineView);

        var _this10 = _possibleConstructorReturn(this, (LineView.__proto__ || Object.getPrototypeOf(LineView)).apply(this, arguments));

        _this10.children = [];
        _this10.length = 0;
        _this10.prevAttrs = undefined;
        _this10.attrs = null;
        _this10.breakAfter = 0;
        return _this10;
    }
    // Consumes source
    ...
    _createClass(LineView, [{
        ...
        value: function split(at) {
            ...
            var _childPos = this.childPos(at),
                i = _childPos.i,
                off = _childPos.off;
        ...
        value: function sync(track) {
            ...
            _get(LineView.prototype.__proto__ || Object.getPrototypeOf(LineView.prototype), 'sync', this).call(this, track);
...
var BlockWidgetView = function (_ContentView3) {
    _inherits(BlockWidgetView, _ContentView3);

    function BlockWidgetView(widget, length, type) {
        _classCallCheck(this, BlockWidgetView);

        var _this11 = _possibleConstructorReturn(this, (BlockWidgetView.__proto__ || Object.getPrototypeOf(BlockWidgetView)).call(this));

        _this11.widget = widget;
        _this11.length = length;
        _this11.type = type;
        _this11.breakAfter = 0;
        return _this11;
    }
    ...
    _createClass(BlockWidgetView, [{
        ...
        key: 'overrideDOMText',
        get: function get() {
            return this.parent ? this.parent.view.state.doc.slice(this.posAtStart, this.posAtEnd) : _state2.Text.empty;
        }
    }]);
        ...
        value: function buildText(length, active, openStart) {
            while (length > 0) {
                if (this.textOff == this.text.length) {
                    var _cursor$next = this.cursor.next(this.skip),
                        value = _cursor$next.value,
                        lineBreak = _cursor$next.lineBreak,
                        done = _cursor$next.done;
...
var NullWidget = function (_WidgetType) {
    _inherits(NullWidget, _WidgetType);

    function NullWidget(tag) {
        _classCallCheck(this, NullWidget);

        var _this12 = _possibleConstructorReturn(this, (NullWidget.__proto__ || Object.getPrototypeOf(NullWidget)).call(this));
...
var none = [];
var clickAddsSelectionRange = _state2.Facet.define();
var dragMovesSelection$1 = _state2.Facet.define();
var mouseSelectionStyle = _state2.Facet.define();
var exceptionSink = _state2.Facet.define();
var updateListener = _state2.Facet.define();
var inputHandler = _state2.Facet.define();
...
var editable = _state2.Facet.define({ combine: function combine(values) {
...
var nextPluginID = 0;
var viewPlugin = _state2.Facet.define();
    ...
    _createClass(ViewPlugin, null, [{
        ...
        value: function define(create, spec) {
            ...
            if (provide) {
                ...
                try {
                    for (var _iterator9 = (Array.isArray(provide) ? provide : [provide])[Symbol.iterator](), _step9; !(_iteratorNormalCompletion9 = (_step9 = _iterator9.next()).done); _iteratorNormalCompletion9 = true) {
                        var _provider = _step9.value;

                        fields.push(_provider);
                    }
                } catch (err) {
                ...
                return { plugin: value, handlers: eventHandlers };
            }));
...
var PluginInstance = function () {
    ...
    _createClass(PluginInstance, [{
        ...
        value: function takeField(type, target) {
            ...
            try {
                for (var _iterator10 = this.spec.fields[Symbol.iterator](), _step10; !(_iteratorNormalCompletion10 = (_step10 = _iterator10.next()).done); _iteratorNormalCompletion10 = true) {
...
var editorAttributes = _state2.Facet.define({
...
var contentAttributes = _state2.Facet.define({
    combine: function combine(values) {
        return values.reduce(function (a, b) {
            return combineAttrs(b, a);
        }, {});
...
// Provide decorations
var decorations = _state2.Facet.define();
var styleModule = _state2.Facet.define();

var ChangedRange = function () {
...
var ViewUpdate = function () {
    ...
    state) {
        ...
        this.changes = _state2.ChangeSet.empty(this.startState.doc.length);
        var _iteratorNormalCompletion11 = true;
        var _didIteratorError11 = false;
        var _iteratorError11 = undefined;

        try {
            for (var _iterator11 = transactions[Symbol.iterator](), _step11; !(_iteratorNormalCompletion11 = (_step11 = _iterator11.next()).done); _iteratorNormalCompletion11 = true) {
...
var DocView = function (_ContentView4) {
    _inherits(DocView, _ContentView4);

    function DocView(view) {
        _classCallCheck(this, DocView);

        var _this13 = _possibleConstructorReturn(this, (DocView.__proto__ || Object.getPrototypeOf(DocView)).call(this));

        _this13.view = view;
        _this13.compositionDeco = Decoration.none;
        _this13.decorations = [];
        ...
        // forget it again.
        _this13.minWidth = 0;
        _this13.minWidthFrom = 0;
        _this13.minWidthTo = 0;
        // Track whether the DOM selection was set in a lossy way, so that
        // we don't mess it up when reading it back it
        _this13.impreciseAnchor = null;
        _this13.impreciseHead = null;
        _this13.setDOM(view.contentDOM);
        _this13.children = [new LineView()];
        _this13.children[0].setParent(_this13);
        _this13.updateInner([new ChangedRange(0, 0, 0, view.state.doc.length)], _this13.updateDeco(), 0);
        return _this13;
    }
    ...
    _createClass(DocView, [{
        ...
        value: function update(_update) {
            ...
            if (this.minWidth > 0 && changedRanges.length) {
                if (!changedRanges.every(function (_ref4) {
                    var fromA = _ref4.fromA,
                        toA = _ref4.toA;
                    return toA < _this14.minWidthFrom || fromA > _this14.minWidthTo;
                })) {
                    this.minWidth = 0;
                } else {
            ...
            var pointerSel = _update.transactions.some(function (tr) {
                return tr.annotation(_state2.Transaction.userEvent) == "pointerselection";
            });
        ...
        value: function updateInner(changes, deco, oldLength) {
            ...
            this.view.observer.ignore(function () {
                ...
                _this15.dom.style.height = _this15.view.viewState.domHeight + "px";
                _this15.dom.style.minWidth = _this15.minWidth ? _this15.minWidth + "px" : "";
                // Chrome will sometimes, when DOM mutations occur directly
                // around the selection, get confused and report a different
                // selection from the one it displays (issue #218). This tries
                // to detect that situation.
                var track = browser.chrome ? { node: getSelection(_this15.view.root).focusNode, written: false } : undefined;
                _this15.sync(track);
                _this15.dirty = 0 /* Not */;
                if (track === null || track === void 0 ? void 0 : track.written) forceSelection = true;
                _this15.updateSelection(forceSelection, pointerSel);
                _this15.dom.style.height = "";
            });
        }
    }, {
        key: 'updateChildren',
        ...
        key: 'domAtPos',
        value: function domAtPos(pos) {
            var _childCursor$findPos = this.childCursor().findPos(pos, -1),
                i = _childCursor$findPos.i,
                off = _childCursor$findPos.off;
        ...
        value: function measureVisibleLineHeights() {
            var result = [],
                _view$viewState$viewp = this.view.viewState.viewport,
                from = _view$viewState$viewp.from,
                to = _view$viewState$viewp.to;
        ...
        value: function scrollPosIntoView(pos, side) {
            ...
            try {
                for (var _iterator13 = this.view.pluginField(PluginField.scrollMargins)[Symbol.iterator](), _step13; !(_iteratorNormalCompletion13 = (_step13 = _iterator13.next()).done); _iteratorNormalCompletion13 = true) {
...
var BlockGapWidget = function (_WidgetType2) {
    _inherits(BlockGapWidget, _WidgetType2);

    function BlockGapWidget(height) {
        _classCallCheck(this, BlockGapWidget);

        var _this17 = _possibleConstructorReturn(this, (BlockGapWidget.__proto__ || Object.getPrototypeOf(BlockGapWidget)).call(this));
...
var CompositionWidget = function (_WidgetType3) {
    _inherits(CompositionWidget, _WidgetType3);

    function CompositionWidget(top, text) {
        _classCallCheck(this, CompositionWidget);

        var _this18 = _possibleConstructorReturn(this, (CompositionWidget.__proto__ || Object.getPrototypeOf(CompositionWidget)).call(this));
...
var DecorationComparator$1 = function () {
...
function computeOrder(line, direction) {
    ...
    for (var _i2 = 0, _prev = outerType, _prevStrong = outerType; _i2 < len; _i2++) {
        var _type2 = types[_i2];
        if (_type2 == 128 /* CS */) {
                if (_i2 < len - 1 && _prev == types[_i2 + 1] && _prev & 24 /* Num */) _type2 = types[_i2] = _prev;else types[_i2] = 256 /* NI */;
            } else if (_type2 == 64 /* ET */) {
                var end = _i2 + 1;
                while (end < len && types[end] == 64 /* ET */) {
                    end++;
                }var replace = _i2 && _prev == 8 /* EN */ || end < len && types[end] == 8 /* EN */ ? _prevStrong == 1 /* L */ ? 1 /* L */ : 8 /* EN */ : 256 /* NI */;
                for (var j = _i2; j < end; j++) {
                    types[j] = replace;
                }_i2 = end - 1;
    ...
    if (outerType == 1 /* L */) {
            for (var _i4 = 0; _i4 < len;) {
                var start = _i4,
                    rtl = types[_i4++] != 1 /* L */;
                while (_i4 < len && rtl == (types[_i4] != 1 /* L */)) {
                    _i4++;
                }if (rtl) {
                    for (var _j2 = _i4; _j2 > start;) {
                        var _end3 = _j2,
                            l = types[--_j2] != 2 /* R */;
                        while (_j2 > start && l == (types[_j2 - 1] != 2 /* R */)) {
                            _j2--;
                        }order.push(new BidiSpan(_j2, _end3, l ? 2 : 1));
                    }
                } else {
                    order.push(new BidiSpan(start, _i4, 0));
                }
            }
        } else {
        for (var _i5 = 0; _i5 < len;) {
            var _start3 = _i5,
                _rtl = types[_i5++] == 2 /* R */;
            while (_i5 < len && _rtl == (types[_i5] == 2 /* R */)) {
                _i5++;
            }order.push(new BidiSpan(_start3, _i5, _rtl ? 1 : 2));
        }
    }
    return order;
}
...
function moveVisually(line, order, dir, start, forward) {
    ...
    if (nextIndex != span.side(forward, dir)) return _state2.EditorSelection.cursor(nextIndex + line.from, indexForward ? -1 : 1, span.level);
    var nextSpan = spanI == (forward ? order.length - 1 : 0) ? null : order[spanI + (forward ? 1 : -1)];
    if (!nextSpan && span.level != dir) return _state2.EditorSelection.cursor(forward ? line.to : line.from, forward ? -1 : 1, dir);
    if (nextSpan && nextSpan.level < span.level) return _state2.EditorSelection.cursor(nextSpan.side(!forward, dir) + line.from, 0, nextSpan.level);
    return _state2.EditorSelection.cursor(nextIndex + line.from, 0, span.level);
}
...
function groupAt(state, pos) {
    ...
    if (line.length == 0) return _state2.EditorSelection.cursor(pos);
    ...
    return _state2.EditorSelection.range(from + line.from, to + line.from);
}
...
function _moveToLineBoundary(view, start, forward, includeWrap) {
    ...
    if (coords) {
        ...
        if (pos != null) return _state2.EditorSelection.cursor(pos, forward ? -1 : 1);
    }
    ...
    return _state2.EditorSelection.cursor(end, forward ? -1 : 1);
}
function _moveByChar(view, start, forward, by) {
    ...
    for (var cur = start, check = null;;) {
        ...
        if (!next) {
            ...
            spans = view.bidiSpans(line);
            next = _state2.EditorSelection.cursor(forward ? line.from : line.to);
        }
        if (!check) {
            if (!by) return next;
            check = by(char);
...
function byGroup(view, pos, start) {
    ...
    return function (next) {
        ...
        if (cat == _state2.CharCategory.Space) cat = nextCat;
        return cat == nextCat;
    };
}
function _moveVertically(view, start, forward, distance) {
    ...
    var startPos = start.head,
        dir = forward ? 1 : -1;
    if (startPos == (forward ? view.state.doc.length : 0)) return _state2.EditorSelection.cursor(startPos);
    ...
    if (startCoords) {
        ...
        for (var startY = dir < 0 ? startCoords.top : startCoords.bottom, extra = 0; extra < 50; extra += 10) {
            var pos = _posAtCoords(view, { x: resolvedGoal, y: startY + (dist + extra) * dir }, dir);
            if (pos == null) break;
            if (pos != startPos) return _state2.EditorSelection.cursor(pos, undefined, undefined, _goal);
        }
    }
    ...
    if (dir < 0 && line.from == 0) return _state2.EditorSelection.cursor(0);else if (dir > 0 && line.to == doc.length) return _state2.EditorSelection.cursor(line.to);
    ...
    return _state2.EditorSelection.cursor(result, undefined, undefined, goal);
}
...
var InputState = function () {
    function InputState(view) {
        ...
        var _loop = function _loop(type) {
            ...
            view.contentDOM.addEventListener(type, function (event) {
                if (!eventBelongsToEditor(view, event) || _this19.ignoreDuringComposition(event) || type == "keydown" && _this19.screenKeyEvent(view, event)) return;
                if (_this19.mustFlushObserver(event)) view.observer.forceFlush();
                if (_this19.runCustomHandlers(type, view, event)) event.preventDefault();else handler(view, event);
            });
    ...
    _createClass(InputState, [{
        ...
        value: function runCustomHandlers(type, view, event) {
            ...
            try {
                for (var _iterator15 = this.customHandlers[Symbol.iterator](), _step15; !(_iteratorNormalCompletion15 = (_step15 = _iterator15.next()).done); _iteratorNormalCompletion15 = true) {
                    var set = _step15.value;

                    var _handler = set.handlers[type],
                        handled = false;
                    if (_handler) {
                        try {
                            handled = _handler.call(set.plugin, event, view);
                        } catch (e) {
        ...
        value: function runScrollHandlers(view, event) {
            ...
            try {
                for (var _iterator16 = this.customHandlers[Symbol.iterator](), _step16; !(_iteratorNormalCompletion16 = (_step16 = _iterator16.next()).done); _iteratorNormalCompletion16 = true) {
                    var set = _step16.value;

                    var _handler2 = set.handlers.scroll;
                    if (_handler2) {
                        try {
                            _handler2.call(set.plugin, event, view);
                        } catch (e) {
                            logException(view.state, e);
                        }
                    }
...
var MouseSelection = function () {
    function MouseSelection(inputState, view, startEvent, style) {
        ...
        this.multiple = view.state.facet(_state2.EditorState.allowMultipleSelections) && addsSelectionRange(view, startEvent);
    ...
    _createClass(MouseSelection, [{
        ...
        value: function select(event) {
            ...
            if (!selection.eq(this.view.state.selection) || selection.main.assoc != this.view.state.selection.main.assoc) this.view.dispatch({
                selection: selection,
                annotations: _state2.Transaction.userEvent.of("pointerselection"),
                scrollIntoView: true
            });
        }
    }, {
...
function doPaste(view, input) {
    ...
    if (linewise) {
        ...
        changes = state.changeByRange(function (range) {
            ...
            if (line.from == lastLine) return { range: range };
            lastLine = line.from;
            var insert = state.toText((byLine ? text.line(i++).text : input) + state.lineBreak);
            return { changes: { from: line.from, insert: insert },
                range: _state2.EditorSelection.cursor(range.from + insert.length) };
        });
    } else if (byLine) {
        changes = state.changeByRange(function (range) {
            var line = text.line(i++);
            return { changes: { from: range.from, to: range.to, insert: line.text },
                range: _state2.EditorSelection.cursor(range.from + line.length) };
        });
    } else {
        changes = state.replaceSelection(text);
    }
    view.dispatch(changes, {
        annotations: _state2.Transaction.userEvent.of("paste"),
        scrollIntoView: true
    });
}
function mustCapture(event) {
    var mods = (event.ctrlKey ? 1 /* Ctrl */ : 0) | (event.metaKey ? 8 /* Meta */ : 0) | (event.altKey ? 2 /* Alt */ : 0) | (event.shiftKey ? 4 /* Shift */ : 0);
    var code = event.keyCode,
        macCtrl = browser.mac && mods == 1 /* Ctrl */;
...
handlers.mousedown = function (view, event) {
    ...
    try {
        for (var _iterator17 = view.state.facet(mouseSelectionStyle)[Symbol.iterator](), _step17; !(_iteratorNormalCompletion17 = (_step17 = _iterator17.next()).done); _iteratorNormalCompletion17 = true) {
            var makeStyle = _step17.value;
...
function rangeForClick(view, pos, bias, type) {
    if (type == 1) {
        // Single click
        return _state2.EditorSelection.cursor(pos, bias);
    } else if (type == 2) {
        // Double click
        ...
        if (line) return _state2.EditorSelection.range(line.posAtStart, line.posAtEnd);

        var _view$state$doc$lineA = view.state.doc.lineAt(pos),
            from = _view$state$doc$lineA.from,
            to = _view$state$doc$lineA.to;

        return _state2.EditorSelection.range(from, to);
    }
}
    ...
    return {
        ...
        get: function get(event, extend, multiple) {
            ...
            if (start.pos != cur.pos && !extend) {
                ...
                range = from < range.from ? _state2.EditorSelection.range(from, to) : _state2.EditorSelection.range(to, from);
            }
            if (extend) return startSel.replaceRange(startSel.main.extend(range.from, range.to));else if (multiple) return startSel.addRange(range);else return _state2.EditorSelection.create([range]);
        }
    };
}
...
handlers.drop = function (view, event) {
    ...
    var del = mouseSelection && mouseSelection.dragging && mouseSelection.dragMove ? { from: mouseSelection.dragging.from, to: mouseSelection.dragging.to } : null;
    ...
    view.dispatch({
        ...
        annotations: _state2.Transaction.userEvent.of("drop")
    });
};
...
function copiedRange(state) {
    ...
    try {
        for (var _iterator18 = state.selection.ranges[Symbol.iterator](), _step18; !(_iteratorNormalCompletion18 = (_step18 = _iterator18.next()).done); _iteratorNormalCompletion18 = true) {
            var range = _step18.value;
    ...
    if (!content.length) {
        ...
        try {
            for (var _iterator19 = state.selection.ranges[Symbol.iterator](), _step19; !(_iteratorNormalCompletion19 = (_step19 = _iterator19.next()).done); _iteratorNormalCompletion19 = true) {
                var from = _step19.value.from;
...
handlers.copy = handlers.cut = function (view, event) {
    ...
    if (event.type == "cut") view.dispatch({
        changes: ranges,
        scrollIntoView: true,
        annotations: _state2.Transaction.userEvent.of("cut")
    });
};
...
var HeightMapBlock = function (_HeightMap) {
    _inherits(HeightMapBlock, _HeightMap);

    function HeightMapBlock(length, height, type) {
        _classCallCheck(this, HeightMapBlock);

        var _this21 = _possibleConstructorReturn(this, (HeightMapBlock.__proto__ || Object.getPrototypeOf(HeightMapBlock)).call(this, length, height));
...
var HeightMapText = function (_HeightMapBlock) {
    _inherits(HeightMapText, _HeightMapBlock);

    function HeightMapText(length, height) {
        _classCallCheck(this, HeightMapText);

        var _this22 = _possibleConstructorReturn(this, (HeightMapText.__proto__ || Object.getPrototypeOf(HeightMapText)).call(this, length, height, BlockType.Text));
...
var HeightMapGap = function (_HeightMap2) {
    _inherits(HeightMapGap, _HeightMap2);

    function HeightMapGap(length) {
        _classCallCheck(this, HeightMapGap);

        return _possibleConstructorReturn(this, (HeightMapGap.__proto__ || Object.getPrototypeOf(HeightMapGap)).call(this, length, 0));
    }
    ...
    _createClass(HeightMapGap, [{
        ...
        value: function blockAt(height, doc, top, offset) {
            var _lines = this.lines(doc, offset),
                firstLine = _lines.firstLine,
                lastLine = _lines.lastLine,
                lineHeight = _lines.lineHeight;
        ...
        value: function lineAt(value, type, doc, top, offset) {
            ...
            var _lines2 = this.lines(doc, offset),
                firstLine = _lines2.firstLine,
                lineHeight = _lines2.lineHeight;
        ...
        value: function forEachLine(from, to, doc, top, offset, f) {
            var _lines3 = this.lines(doc, offset),
                firstLine = _lines3.firstLine,
                lineHeight = _lines3.lineHeight;
...
var HeightMapBranch = function (_HeightMap3) {
    _inherits(HeightMapBranch, _HeightMap3);

    function HeightMapBranch(left, brk, right) {
        _classCallCheck(this, HeightMapBranch);

        var _this24 = _possibleConstructorReturn(this, (HeightMapBranch.__proto__ || Object.getPrototypeOf(HeightMapBranch)).call(this, left.length + brk + right.length, left.height + right.height, brk | (left.outdated || right.outdated ? 2 /* Outdated */ : 0)));
...
var NodeBuilder = function () {
    ...
    _createClass(NodeBuilder, [{
        ...
        value: function enterLine() {
            ...
            var _oracle$doc$lineAt = this.oracle.doc.lineAt(this.pos),
        ...
        value: function finish(from) {
            ...
            try {
                for (var _iterator21 = this.nodes[Symbol.iterator](), _step21; !(_iteratorNormalCompletion21 = (_step21 = _iterator21.next()).done); _iteratorNormalCompletion21 = true) {
...
var DecorationComparator = function () {
...
var LineGapWidget = function (_WidgetType4) {
    _inherits(LineGapWidget, _WidgetType4);

    function LineGapWidget(size, vertical) {
        _classCallCheck(this, LineGapWidget);

        var _this25 = _possibleConstructorReturn(this, (LineGapWidget.__proto__ || Object.getPrototypeOf(LineGapWidget)).call(this));
...
var ViewState = function () {
    ...
    _createClass(ViewState, [{
        ...
        value: function updateForViewport() {
            ...
            var _loop3 = function _loop3(i) {
                ...
                if (!viewports.some(function (_ref7) {
                    ...
                    var _lineAt = _this26.lineAt(pos, 0),
                        from = _lineAt.from,
                        to = _lineAt.to;
        ...
        value: function update(_update5) {
            ...
            var heightChanges = ChangedRange.extendWithRanges(contentChanges, heightRelevantDecoChanges(_update5.startState.facet(decorations), newDeco, _update5 ? _update5.changes : _state2.ChangeSet.empty(this.state.doc.length)));
        ...
        value: function viewportIsAppropriate(_ref8) {
            ...
            var _heightMap$lineAt = this.heightMap.lineAt(from, QueryType.ByPos, this.state.doc, 0, 0),
                top = _heightMap$lineAt.top;

            var _heightMap$lineAt2 = this.heightMap.lineAt(to, QueryType.ByPos, this.state.doc, 0, 0),
                bottom = _heightMap$lineAt2.bottom;
        ...
        value: function mapLineGaps(gaps, changes) {
            ...
            try {
                for (var _iterator22 = gaps[Symbol.iterator](), _step22; !(_iteratorNormalCompletion22 = (_step22 = _iterator22.next()).done); _iteratorNormalCompletion22 = true) {
                    var gap = _step22.value;
        ...
        value: function ensureLineGaps(current) {
            ...
            this.heightMap.forEachLine(this.viewport.from, this.viewport.to, this.state.doc, 0, 0, function (line) {
                ...
                var structure = lineStructure(line.from, line.to, _this27.state);
                if (structure.total < 10000 /* Margin */) return;
                var viewFrom = void 0,
                    viewTo = void 0;
                if (_this27.heightOracle.lineWrapping) {
                    if (line.from != _this27.viewport.from) viewFrom = line.from;else viewFrom = findPosition(structure, (_this27.visibleTop - line.top) / line.height);
                    if (line.to != _this27.viewport.to) viewTo = line.to;else viewTo = findPosition(structure, (_this27.visibleBottom - line.top) / line.height);
                } else {
                    var totalWidth = structure.total * _this27.heightOracle.charWidth;
                    viewFrom = findPosition(structure, _this27.pixelViewport.left / totalWidth);
                    viewTo = findPosition(structure, _this27.pixelViewport.right / totalWidth);
                }
                var sel = _this27.state.selection.main;
                ...
                if (gapTo > line.from + 5000 /* HalfMargin */) gaps.push(find(current, function (gap) {
                    ...
                    } /* HalfMargin */) || new LineGap(line.from, gapTo, _this27.gapSize(line, gapTo, true, structure)));
                if (gapFrom < line.to - 5000 /* HalfMargin */) gaps.push(find(current, function (gap) {
                    ...
                    } /* HalfMargin */) || new LineGap(gapFrom, line.to, _this27.gapSize(line, gapFrom, false, structure)));
            });
            return gaps;
        }
    }, {
        ...
        value: function updateLineGaps(gaps) {
            ...
            if (!LineGap.same(gaps, this.lineGaps)) {
                ...
                this.lineGapDeco = Decoration.set(gaps.map(function (gap) {
                    return gap.draw(_this28.heightOracle.lineWrapping);
                }));
                return 8 /* LineGaps */;
            }
            return 0;
        ...
        value: function forEachLine(from, to, f, editorTop) {
            ...
            return this.heightMap.forEachLine(from, to, this.state.doc, editorTop, 0, this.scaler.scale == 1 ? f : function (b) {
                return f(scaleBlock(b, _this29.scaler, editorTop));
            });
        }
    }, {
        key: 'visibleTop',
...
function findFraction(structure, pos) {
    ...
    try {
        for (var _iterator23 = structure.ranges[Symbol.iterator](), _step23; !(_iteratorNormalCompletion23 = (_step23 = _iterator23.next()).done); _iteratorNormalCompletion23 = true) {
            var _step23$value = _step23.value,
                from = _step23$value.from,
                to = _step23$value.to;
...
var BigScaler = function () {
    function BigScaler(doc, heightMap, viewports) {
        ...
        try {
            for (var _iterator25 = this.viewports[Symbol.iterator](), _step25; !(_iteratorNormalCompletion25 = (_step25 = _iterator25.next()).done); _iteratorNormalCompletion25 = true) {
                var obj = _step25.value;
    ...
    _createClass(BigScaler, [{
        ...
        value: function toDOM(n, top) {
            n -= top;
            for (var i = 0, _base = 0, _domBase = 0;; i++) {
                var vp = i < this.viewports.length ? this.viewports[i] : null;
                if (!vp || n < vp.top) return _domBase + (n - _base) * this.scale + top;
                if (n <= vp.bottom) return vp.domTop + (n - vp.top) + top;
                _base = vp.bottom;
                _domBase = vp.domBottom;
            }
        }
    }, {
        key: 'fromDOM',
        value: function fromDOM(n, top) {
            n -= top;
            for (var i = 0, _base2 = 0, _domBase2 = 0;; i++) {
                var vp = i < this.viewports.length ? this.viewports[i] : null;
                if (!vp || n < vp.domTop) return _base2 + (n - _domBase2) / this.scale + top;
                if (n <= vp.domBottom) return vp.top + (n - vp.domTop) + top;
                _base2 = vp.bottom;
                _domBase2 = vp.domBottom;
            }
        }
    }]);
...
var _theme = _state2.Facet.define({ combine: function combine(strs) {
        return strs.join(" ");
    } });
var darkTheme = _state2.Facet.define({ combine: function combine(values) {
...
var DOMObserver = function () {
    function DOMObserver(view, onChange, onScrollChanged) {
        ...
        this.observer = new MutationObserver(function (mutations) {
            ...
            try {
                for (var _iterator26 = mutations[Symbol.iterator](), _step26; !(_iteratorNormalCompletion26 = (_step26 = _iterator26.next()).done); _iteratorNormalCompletion26 = true) {
                    var mut = _step26.value;
        ...
        if (useCharData) this.onCharData = function (event) {
            _this30.queue.push({ target: event.target,
                type: "characterData",
        ...
        if (typeof IntersectionObserver == "function") {
            this.intersection = new IntersectionObserver(function (entries) {
                ...
                if (entries[entries.length - 1].intersectionRatio > 0 != _this30.intersecting) {
                    _this30.intersecting = !_this30.intersecting;
                    _this30.onScrollChanged(document.createEvent("Event"));
                }
            }, {});
    ...
    _createClass(DOMObserver, [{
        ...
        value: function listenForScroll() {
            ...
            if (changed) {
                ...
                try {
                    for (var _iterator27 = this.scrollTargets[Symbol.iterator](), _step27; !(_iteratorNormalCompletion27 = (_step27 = _iterator27.next()).done); _iteratorNormalCompletion27 = true) {
                        var _dom2 = _step27.value;
                ...
                try {
                    for (var _iterator28 = (this.scrollTargets = changed)[Symbol.iterator](), _step28; !(_iteratorNormalCompletion28 = (_step28 = _iterator28.next()).done); _iteratorNormalCompletion28 = true) {
                        var _dom3 = _step28.value;
        ...
        value: function flushSoon() {
            ...
            if (this.delayedFlush < 0) this.delayedFlush = window.setTimeout(function () {
                _this31.delayedFlush = -1;_this31.flush();
            }, 20);
        }
    }, {
        key: 'forceFlush',
        ...
        value: function flush() {
            ...
            try {
                for (var _iterator29 = this.observer.takeRecords()[Symbol.iterator](), _step29; !(_iteratorNormalCompletion29 = (_step29 = _iterator29.next()).done); _iteratorNormalCompletion29 = true) {
                    var mut = _step29.value;
            ...
            try {
                for (var _iterator30 = records[Symbol.iterator](), _step30; !(_iteratorNormalCompletion30 = (_step30 = _iterator30.next()).done); _iteratorNormalCompletion30 = true) {
                    var record = _step30.value;
            ...
            if (this.view.state == startState) {
                ...
                if (this.view.docView.dirty) {
                    this.ignore(function () {
                        return _this32.view.docView.sync();
                    });
        ...
        value: function destroy() {
            ...
            try {
                for (var _iterator31 = this.scrollTargets[Symbol.iterator](), _step31; !(_iteratorNormalCompletion31 = (_step31 = _iterator31.next()).done); _iteratorNormalCompletion31 = true) {
                    var dom = _step31.value;
...
function applyDOMChange(view, start, end, typeOver) {
    ...
    if (start > -1 && (bounds = view.docView.domBoundsAround(start, end, 0))) {
        ...
        if (head != sel.head || anchor != sel.anchor) newSel = _state2.EditorSelection.single(anchor, head);
    }
    if (!change && !newSel) return;
    // Heuristic to notice typing over a selected character
    if (!change && typeOver && !sel.empty && newSel && newSel.main.empty) change = { from: sel.from, to: sel.to, insert: view.state.doc.slice(sel.from, sel.to) };
    if (change) {
        ...
        view.dispatch(tr, { scrollIntoView: true, annotations: _state2.Transaction.userEvent.of("input") });
    } else if (newSel && !newSel.main.eq(sel)) {
        var scrollIntoView = false,
            annotations = void 0;
        if (view.inputState.lastSelectionTime > Date.now() - 50) {
            if (view.inputState.lastSelectionOrigin == "keyboardselection") scrollIntoView = true;else annotations = _state2.Transaction.userEvent.of(view.inputState.lastSelectionOrigin);
        }
...
var DOMReader = function () {
    ...
    _createClass(DOMReader, [{
        ...
        value: function findPointBefore(node, next) {
            ...
            try {
                for (var _iterator32 = this.points[Symbol.iterator](), _step32; !(_iteratorNormalCompletion32 = (_step32 = _iterator32.next()).done); _iteratorNormalCompletion32 = true) {
        ...
        value: function findPointIn(node, maxLen) {
            ...
            try {
                for (var _iterator33 = this.points[Symbol.iterator](), _step33; !(_iteratorNormalCompletion33 = (_step33 = _iterator33.next()).done); _iteratorNormalCompletion33 = true) {
...
function selectionFromPoints(points, base) {
    ...
    return anchor > -1 && head > -1 ? _state2.EditorSelection.single(anchor + base, head + base) : null;
}
...
var EditorView = function () {
    ...
    function EditorView() {
        ...
        this.viewState = new ViewState(config.state || _state2.EditorState.create());
    ...
    _createClass(EditorView, [{
        ...
        value: function dispatch() {
            ...
            this._dispatch(arguments.length == 1 && (arguments.length <= 0 ? undefined : arguments[0]) instanceof _state2.Transaction ? arguments.length <= 0 ? undefined : arguments[0] : (_state = this.state).update.apply(_state, arguments));
        }
        ...
        value: function update(transactions) {
            ...
            try {
                for (var _iterator34 = transactions[Symbol.iterator](), _step34; !(_iteratorNormalCompletion34 = (_step34 = _iterator34.next()).done); _iteratorNormalCompletion34 = true) {
                    var tr = _step34.value;
            ...
            if (state.facet(_state2.EditorState.phrases) != this.state.facet(_state2.EditorState.phrases)) return this.setState(state);
            ...
            if (!update.empty) {
                ...
                try {
                    for (var _iterator35 = this.state.facet(updateListener)[Symbol.iterator](), _step35; !(_iteratorNormalCompletion35 = (_step35 = _iterator35.next()).done); _iteratorNormalCompletion35 = true) {
                        var _listener = _step35.value;
        ...
        value: function setState(newState) {
            ...
            try {
                ...
                try {
                    for (var _iterator36 = this.plugins[Symbol.iterator](), _step36; !(_iteratorNormalCompletion36 = (_step36 = _iterator36.next()).done); _iteratorNormalCompletion36 = true) {
                        var plugin = _step36.value;
                ...
                this.plugins = newState.facet(viewPlugin).map(function (spec) {
                    return new PluginInstance(spec).update(_this34);
                });
                this.docView = new DocView(this);
        ...
        value: function updatePlugins(update) {
            ...
            if (prevSpecs != specs) {
                ...
                try {
                    for (var _iterator37 = specs[Symbol.iterator](), _step37; !(_iteratorNormalCompletion37 = (_step37 = _iterator37.next()).done); _iteratorNormalCompletion37 = true) {
                        var spec = _step37.value;
                ...
                try {
                    for (var _iterator38 = this.plugins[Symbol.iterator](), _step38; !(_iteratorNormalCompletion38 = (_step38 = _iterator38.next()).done); _iteratorNormalCompletion38 = true) {
                ...
                try {
                    for (var _iterator39 = this.plugins[Symbol.iterator](), _step39; !(_iteratorNormalCompletion39 = (_step39 = _iterator39.next()).done); _iteratorNormalCompletion39 = true) {
                        var p = _step39.value;
        ...
        value: function measure() {
            ...
            try {
                for (var i = 0;; i++) {
                    ...
                    var measured = measuring.map(function (m) {
                        try {
                            return m.read(_this35);
                        } catch (e) {
                            logException(_this35.state, e);
                            return BadMeasure;
                        }
                    });
                    ...
                    for (var _i6 = 0; _i6 < measuring.length; _i6++) {
                        if (measured[_i6] != BadMeasure) {
                            try {
                                measuring[_i6].write(measured[_i6], this);
                            } catch (e) {
            ...
            if (updated && !updated.empty) {
                ...
                try {
                    for (var _iterator40 = this.state.facet(updateListener)[Symbol.iterator](), _step40; !(_iteratorNormalCompletion40 = (_step40 = _iterator40.next()).done); _iteratorNormalCompletion40 = true) {
                        var _listener2 = _step40.value;
        ...
        value: function showAnnouncements(trs) {
            ...
            try {
                for (var _iterator41 = trs[Symbol.iterator](), _step41; !(_iteratorNormalCompletion41 = (_step41 = _iterator41.next()).done); _iteratorNormalCompletion41 = true) {
                    ...
                    try {
                        for (var _iterator42 = tr.effects[Symbol.iterator](), _step42; !(_iteratorNormalCompletion42 = (_step42 = _iterator42.next()).done); _iteratorNormalCompletion42 = true) {
                            var effect = _step42.value;
        ...
        value: function readMeasured() {
            ...
            if (this.updateState == 0 /* Idle */ && this.measureScheduled > -1) this.measure();
        }
        ...
        value: function pluginField(field) {
            ...
            try {
                for (var _iterator43 = this.plugins[Symbol.iterator](), _step43; !(_iteratorNormalCompletion43 = (_step43 = _iterator43.next()).done); _iteratorNormalCompletion43 = true) {
                    var plugin = _step43.value;
        ...
        value: function plugin(_plugin2) {
            ...
            try {
                for (var _iterator44 = this.plugins[Symbol.iterator](), _step44; !(_iteratorNormalCompletion44 = (_step44 = _iterator44.next()).done); _iteratorNormalCompletion44 = true) {
                    var inst = _step44.value;
        ...
        value: function scrollPosIntoView(pos) {
            this.viewState.scrollTo = _state2.EditorSelection.cursor(pos);
            this.requestMeasure();
        }
        ...
        value: function bidiSpans(line) {
            ...
            try {
                for (var _iterator45 = this.bidiCache[Symbol.iterator](), _step45; !(_iteratorNormalCompletion45 = (_step45 = _iterator45.next()).done); _iteratorNormalCompletion45 = true) {
        ...
        value: function destroy() {
            ...
            try {
                for (var _iterator46 = this.plugins[Symbol.iterator](), _step46; !(_iteratorNormalCompletion46 = (_step46 = _iterator46.next()).done); _iteratorNormalCompletion46 = true) {
                    var plugin = _step46.value;
        ...
        value: function theme(spec, options) {
            ...
            var result = [_theme.of(prefix), styleModule.of(buildTheme('.' + prefix, spec))];
        ...
        value: function baseTheme(spec) {
            return _state2.Prec.fallback(styleModule.of(buildTheme("." + baseThemeID, spec, lightDarkIDs)));
        }
    }]);
...
/// search match).
EditorView.announce = _state2.StateEffect.define();
...
var keymap = _state2.Facet.define({ enables: handleKeyEvents });
...
function buildKeymap(bindings) {
    ...
    try {
        for (var _iterator47 = bindings[Symbol.iterator](), _step47; !(_iteratorNormalCompletion47 = (_step47 = _iterator47.next()).done); _iteratorNormalCompletion47 = true) {
            var b = _step47.value;
            ...
            try {
                for (var _iterator48 = (b.scope ? b.scope.split(" ") : ["editor"])[Symbol.iterator](), _step48; !(_iteratorNormalCompletion48 = (_step48 = _iterator48.next()).done); _iteratorNormalCompletion48 = true) {
                    var scope = _step48.value;
...
function runHandlers(map, event, view, scope) {
    ...
    var runFor = function runFor(binding) {
        if (binding) {
            ...
            try {
                for (var _iterator49 = binding.commands[Symbol.iterator](), _step49; !(_iteratorNormalCompletion49 = (_step49 = _iterator49.next()).done); _iteratorNormalCompletion49 = true) {
                    var cmd = _step49.value;
...
var selectionConfig = _state2.Facet.define({
...
var drawSelectionPlugin = ViewPlugin.fromClass(function () {
    ...
    _createClass(_class, [{
        ...
        value: function readPos() {
            ...
            try {
                for (var _iterator50 = state.selection.ranges[Symbol.iterator](), _step50; !(_iteratorNormalCompletion50 = (_step50 = _iterator50.next()).done); _iteratorNormalCompletion50 = true) {
                    var r = _step50.value;
            ...
            return { rangePieces: rangePieces, cursors: cursors };
        }
    }, {
        key: 'drawSel',
        value: function drawSel(_ref11) {
            ...
            if (rangePieces.length != this.rangePieces.length || rangePieces.some(function (p, i) {
                ...
                try {
                    for (var _iterator51 = rangePieces[Symbol.iterator](), _step51; !(_iteratorNormalCompletion51 = (_step51 = _iterator51.next()).done); _iteratorNormalCompletion51 = true) {
                        var p = _step51.value;
            ...
            if (cursors.length != this.cursors.length || cursors.some(function (c, i) {
                ...
                if (oldCursors.length !== cursors.length) {
                    ...
                    try {
                        for (var _iterator52 = cursors[Symbol.iterator](), _step52; !(_iteratorNormalCompletion52 = (_step52 = _iterator52.next()).done); _iteratorNormalCompletion52 = true) {
                            var c = _step52.value;
...
var hideNativeSelection = _state2.Prec.override(EditorView.theme(themeSpec));
...
function wrappedLine(view, pos, inside) {
    var range = _state2.EditorSelection.cursor(pos);
...
function measureRange(view, range) {
    ...
    function drawForLine(from, to, line) {
        ...
        try {
            for (var _iterator53 = view.visibleRanges[Symbol.iterator](), _step53; !(_iteratorNormalCompletion53 = (_step53 = _iterator53.next()).done); _iteratorNormalCompletion53 = true) {
                var r = _step53.value;

                if (r.to > start && r.from < end) {
                    for (var _pos2 = Math.max(r.from, start), endPos = Math.min(r.to, end);;) {
                        var docLine = view.state.doc.lineAt(_pos2);
                        var _iteratorNormalCompletion54 = true;
                        var _didIteratorError54 = false;
                        var _iteratorError54 = undefined;

                        try {
                            for (var _iterator54 = view.bidiSpans(docLine)[Symbol.iterator](), _step54; !(_iteratorNormalCompletion54 = (_step54 = _iterator54.next()).done); _iteratorNormalCompletion54 = true) {
                                var span = _step54.value;

                                var spanFrom = span.from + docLine.from,
                                    spanTo = span.to + docLine.from;
                                if (spanFrom >= endPos) break;
                                if (spanTo > _pos2) addSpan(Math.max(spanFrom, _pos2), from == null && spanFrom <= start, Math.min(spanTo, endPos), to == null && spanTo >= end, span.dir);
                            }
                        } catch (err) {
...
function iterMatches(doc, re, from, to, f) {
    re.lastIndex = 0;
    for (var cursor = doc.iterRange(from, to), _pos3 = from, m; !cursor.next().done; _pos3 += cursor.value.length) {
        if (!cursor.lineBreak) while (m = re.exec(cursor.value)) {
            f(_pos3 + m.index, _pos3 + m.index + m[0].length, m);
        }
    }
}
...
var MatchDecorator = function () {
    ...
    _createClass(MatchDecorator, [{
        ...
        value: function createDeco(view) {
            ...
            try {
                for (var _iterator55 = view.visibleRanges[Symbol.iterator](), _step55; !(_iteratorNormalCompletion55 = (_step55 = _iterator55.next()).done); _iteratorNormalCompletion55 = true) {
        ...
        value: function updateRange(view, deco, updateFrom, updateTo) {
            ...
            try {
                for (var _iterator56 = view.visibleRanges[Symbol.iterator](), _step56; !(_iteratorNormalCompletion56 = (_step56 = _iterator56.next()).done); _iteratorNormalCompletion56 = true) {
                    var r = _step56.value;
                        ...
                        (function () {
                            ...
                            if (fromLine == toLine) {
                                ...
                                while ((m = _this42.regexp.exec(fromLine.text)) && m.index < end - fromLine.from) {
                                    var _pos4 = m.index + fromLine.from;
                                    ranges.push(_this42.getDeco(m, view, _pos4).range(_pos4, _pos4 + m[0].length));
                                }
                            } else {
                            ...
                            deco = deco.update({ filterFrom: start, filterTo: end, filter: function filter() {
                                    return false;
                                }, add: ranges });
                        })();
                    }
...
var specialCharConfig = _state2.Facet.define({
    combine: function combine(configs) {
        var config = (0, _state2.combineConfig)(configs, {
            render: null,
...
function specialCharPlugin() {
    return _plugin || (_plugin = ViewPlugin.fromClass(function () {
                ...
                return new MatchDecorator({
                    ...
                    decoration: function decoration(m, view, pos) {
                        ...
                        if (code == 9) {
                            ...
                            return Decoration.replace({ widget: new TabWidget((size - col % size) * _this43.view.defaultCharacterWidth) });
                        }
                        return _this43.decorationCache[code] || (_this43.decorationCache[code] = Decoration.replace({ widget: new SpecialCharWidget(conf, code) }));
                    },
...
var SpecialCharWidget = function (_WidgetType5) {
    _inherits(SpecialCharWidget, _WidgetType5);

    function SpecialCharWidget(options, code) {
        _classCallCheck(this, SpecialCharWidget);

        var _this44 = _possibleConstructorReturn(this, (SpecialCharWidget.__proto__ || Object.getPrototypeOf(SpecialCharWidget)).call(this));
...
var TabWidget = function (_WidgetType6) {
    _inherits(TabWidget, _WidgetType6);

    function TabWidget(width) {
        _classCallCheck(this, TabWidget);

        var _this45 = _possibleConstructorReturn(this, (TabWidget.__proto__ || Object.getPrototypeOf(TabWidget)).call(this));
...
var activeLineHighlighter = ViewPlugin.fromClass(function () {
    ...
    _createClass(_class3, [{
        ...
        value: function getDeco(view) {
            ...
            try {
                for (var _iterator57 = view.state.selection.ranges[Symbol.iterator](), _step57; !(_iteratorNormalCompletion57 = (_step57 = _iterator57.next()).done); _iteratorNormalCompletion57 = true) {
                    var r = _step57.value;
...
var Placeholder = function (_WidgetType7) {
    _inherits(Placeholder, _WidgetType7);

    function Placeholder(content) {
        _classCallCheck(this, Placeholder);

        var _this46 = _possibleConstructorReturn(this, (Placeholder.__proto__ || Object.getPrototypeOf(Placeholder)).call(this));
